...
public class CartBehaviour : MonoBehaviour
{
    ...
    [SerializeField] private EngineTemperature EngineTemperature;
    ...
    void Start()
    {
        ...
        EngineTemperature = GetComponent<EngineTemperature>();
    }
    ...
    {
        float heatval = EngineTemperature.GetEngineTemperature();
